...
- Bridge DB schema v5에 보드 룸/플레이어 및 룸 생성 시점 참가자 방송 상태 영속화가 추가되었고, 현재는 룸 생성·프리뷰·재배치·확정 API까지 구현되었다. SOOP 후원 이벤트를 실제 룸 진행 엔진에 연결하는 단계는 아직 남아 있다.
